...
fig10_leaf_spine = {'ETO': [0.125, 0.125, 0.125, 0.125], 'DSA': [0.25, 0.35, 0.39, 0.438],
                    'ATP': [0.25, 0.4, 0.502, 0.607], 'PS-only': [0.25, 0.5, 0.75, 1.0]}
...
fig11a_leaf_spine = {'ETO': [0.25, 0.5, 0.75, 1.0], 'DSA': [0.0, 0.3, 0.667, 0.875],
                     'ATP': [0.0, 0.2, 0.502, 0.666], 'PS-only': [0.0, 0.0, 0.0, 0.0]}
fig11a_fat_tree = {'ETO': [0.25, 0.5, 0.75, 1.0], 'DSA': [0.126, 0.298, 0.54, 0.888],
                   'ATP': [0.126, 0.265, 0.54, 0.853], 'PS-only': [0.0, 0.0, 0.0, 0.0]}
fig11b_leaf_spine = {'ETO': [0.125, 0.375, 0.625, 0.875], 'DSA': [0.0, 0.15, 0.36, 0.562],
                     'ATP': [0.0, 0.1, 0.248, 0.393], 'PS-only': [0.0, 0.0, 0.0, 0.0]}
fig11b_fat_tree = {'ETO': [0.125, 0.375, 0.625, 0.875], 'DSA': [0.01, 0.063, 0.073, 0.195],
                   'ATP': [0.01, 0.053, 0.073, 0.181], 'PS-only': [0.0, 0.0, 0.0, 0.0]}
fig12_leaf_spine = {'ETO': [0.533, 1.045, 1.539, 2.042], 'DSA': [0.75, 1.3, 1.753, 2.271],
                    'ATP': [0.75, 1.4, 1.938, 2.56], 'PS-only': [0.75, 1.5, 2.25, 3.0]}
fig12_fat_tree = {'ETO': [0.707, 1.441, 2.199, 2.93], 'DSA': [0.874, 1.75, 2.478, 3.184],
                  'ATP': [0.976, 1.887, 2.841, 3.612], 'PS-only': [1.0, 2.0, 3.0, 4.0]}
fig13_leaf_spine = {'ETO': [0.013, 0.013, 0.013, 0.013], 'DSA': [100.0, 100.0, 3.212, 0.812],
                    'ATP': [100.0, 100.0, 11.412, 4.325], 'PS-only': [100.0, 100.0, 100.0, 100.0]}
